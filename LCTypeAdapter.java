 ...
 */
public class LCTypeAdapter extends BaseAdapter{

    Context mContext;
    List<LCAlphabet> listMain = new ArrayList<LCAlphabet>();
    File cacheDir;
    File appDir;
    TextToSpeech tts;


    public LCTypeAdapter() {
    }

    public LCTypeAdapter(Context context,List<LCAlphabet> list) {
        mContext = context;
        listMain = list;
    ...
    public View getView(int i, View convertView, final ViewGroup parent) {
        ...
        final LCAlphabet returnObj = (LCAlphabet) getItem(i);
        ...
        lcImage.setImageBitmap(loadlcTypeImageBit("image"+returnObj.getId()));
         ImageView lcImagetemp1 = (ImageView) customView.findViewById(R.id.lcTypeImage);
        lcImagetemp1.setImageBitmap(loadlcTypeImageBit("image"+returnObj.getId()));
